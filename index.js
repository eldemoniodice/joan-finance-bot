  ...
  try {
    ...
    const prompt = `
      ...
      3. Utiliza estrictamente este diccionario para clasificar:
         ...
         - "Alimentación Secu": pan, cena en restaurantes, cenas de aniversarios, chifa, golosinas, gaseosas, snacks, pedidos, no saludable, panes con queso, panes con palta, etc.
